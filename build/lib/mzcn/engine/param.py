...
# Both hyperopt native spaces and mzcn proxies are valid spaces.
...
class Param(object):
    ...
    parameter tunable in a :class:`mzcn.engine.Tuner`.

        >>> from mzcn.engine.hyper_spaces import quniform
        >>> param = Param(
        ...     name='positive_num',
        ...     value=1,
        ...
        <mzcn.engine.hyper_spaces.quniform object at ...>
    ...
    def __init__(
        ...
        :param hyper_space: Hyper space of the parameter, `None` by default.
            If set, then a :class:`mzcn.engine.ParamTable` that has this
